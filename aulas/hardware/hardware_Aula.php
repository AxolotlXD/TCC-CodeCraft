...
<head>
    ...
    <style>
        .cxa.selecionada{ border-color: #838693ff; }
        .btn_x{ background-color: #838693ff; }
        .custom-progress { background-color: #838693ff; }
        .qeat_cxa.selecionada{ border-color: #838693ff; }
        .form-check-input:checked{ background-color: #838693ff; border-color: #838693ff; }
        .progress{width: 95%;}
    </style>
</head>
<body>
    ...
    <div id="header" class="container-fluid" style="display: flex; flex-direction: row; justify-content: center; align-items: center; gap: 10px;">
        <div class="div_x"> <button class="btn_x" onclick="link(6)">X</button></div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const aulasValidas = [
            'hardware1', 'hardware2', 'hardware3', 'hardware4', 'hardware5', 'hardware6', 'hardware7', 
        ];
