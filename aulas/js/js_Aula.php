...
<head>
    ...
    <style>
        .cxa.selecionada{ border-color: #F6DE19; }
        .btn_x{ background-color: #F6DE19; }
        .custom-progress { background-color: #F6DE19; }
        .qeat_cxa.selecionada{ border-color: #F6DE19; }
        .form-check-input:checked{ background-color: #F6DE19; border-color: #F6DE19; }
        .progress{width: 95%;}
    </style>
</head>
<body>
    ...
    <div id="header" class="container-fluid" style="display: flex; flex-direction: row; justify-content: center; align-items: center; gap: 10px;">
        <div class="div_x"> <button class="btn_x" onclick="link(4)">X</button></div>
